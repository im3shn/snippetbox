...
import (
	...
	"im3shn/snippetbox/internal/validator"
)
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MinChars(form.Password, 8), "password", "Password should be more than 8 characters")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
			form.AddNonFieldErrors("Email or password is invalid")
	...
	app.sessionManager.Put(r.Context(), "authenticationId", id)
